...
- [Databases](databases.md)
  ...
  - [Types of Databases](databases/types-of-databases/README.md) [x]
    - [Relational Database](databases/types-of-databases/relational-database.md) [x]
    - [Document-Oriented Database](databases/types-of-databases/document-oriented-database.md) [x]
    - [Graph Database](databases/types-of-databases/graph-database.md) [x]
    - [Key-Value Database](databases/types-of-databases/key-value-database.md) [x]
    - [Time Series Database](databases/types-of-databases/time-series-database.md) [x]
    - [Wide-Column Database](databases/types-of-databases/wide-column-database.md) [x]
